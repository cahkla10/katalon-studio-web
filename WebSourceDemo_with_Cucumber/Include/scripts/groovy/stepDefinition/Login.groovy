...
class Login {
	...
	@Then("User see {string} title page")
	public void user_see_title_page(String title) {
		WebUI.callTestCase(findTestCase('Pages/Products/Read Page Title'), [('expected') : title], FailureHandling.STOP_ON_FAILURE)
	}
}